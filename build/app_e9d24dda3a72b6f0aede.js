...
n&&!g||!p&&!P&&T[f]||i(T,f,M),
// Plug for library
a[t]=M,a[k]=j,v)if(w={values:S?M:E(h),keys:b?M:E(_),entries:C},g)for(x in w)x in T||s(T,x,w[x]);else r(r.P+r.F*(p||P),t,w);return w}},/***/
...
try{t.call(e,a(N,n,1),a(R,n,1))}catch(e){R.call(n,e)}}):(o._v=e,o._s=1,I(o,!1))}catch(e){R.call({_w:o,_d:!1},e)}}};
...
then:function(e,t){var o=S(_(this,g));return o.ok="function"!=typeof e||e,o.fail="function"==typeof t&&t,o.domain=w?b.domain:void 0,this._c.push(o),this._a&&this._a.push(o),this._s&&I(this,!1),o.promise},
...
C&&i(i.S+i.F*(!q||l(function(){var e=M();
 ...
 *  of patent rights can be found in the PATENTS file in the same directory.
 */
!function(t,o){e.exports=o()}(this,function(){"use strict";function e(e,t){t&&(e.prototype=Object.create(t.prototype)),e.prototype.constructor=e}function t(e){return s(e)?e:T(e)}function o(e){return i(e)?e:I(e)}function n(e){return u(e)?e:M(e)}function r(e){return s(e)&&!a(e)?e:C(e)}function s(e){return!(!e||!e[ao])}function i(e){return!(!e||!e[lo])}function u(e){return!(!e||!e[co])}function a(e){return i(e)||u(e)}function l(e){return!(!e||!e[fo])}function d(e){return e.value=!1,e}function c(e){e&&(e.value=!0)}
...
function ue(e){for(var t=0,o=0;o<e.length;o++)t=31*t+e.charCodeAt(o)|0;return re(t)}function ae(e){var t;if(Ro&&(t=Io.get(e),void 0!==t))return t;if(t=e[Ao],void 0!==t)return t;if(!Lo){if(t=e.propertyIsEnumerable&&e.propertyIsEnumerable[Ao],void 0!==t)return t;if(t=le(e),void 0!==t)return t}if(t=++No,1073741824&No&&(No=0),Ro)Io.set(e,t);else{if(void 0!==Co&&Co(e)===!1)throw new Error("Non-extensible objects are not allowed as keys.");if(Lo)Object.defineProperty(e,Ao,{enumerable:!1,configurable:!1,writable:!1,value:t});else if(void 0!==e.propertyIsEnumerable&&e.propertyIsEnumerable===e.constructor.prototype.propertyIsEnumerable)
...
// #pragma Helper Functions
function Ot(e,t){return D(e)?t:e.constructor(t)}function Et(e){if(e!==Object(e))throw new TypeError("Expected [K, V] tuple: "+e)}function kt(e){return de(e.size),m(e)}function St(e){return i(e)?o:u(e)?n:r}function Pt(e){return Object.create((i(e)?I:u(e)?M:C).prototype)}function Tt(){return this._iter.cacheResult?(this._iter.cacheResult(),this.size=this._iter.size,this):T.prototype.cacheResult.call(this)}function It(e,t){return e>t?1:e<t?-1:0}function Mt(e){var o=k(e);if(!o){
...
// Mixin subclasses
Qt(I,o.prototype),Qt(M,n.prototype),Qt(C,r.prototype),Qt(te,o.prototype),Qt(oe,n.prototype),Qt(ne,r.prototype);var dn={Iterable:t,Seq:T,Collection:ee,Map:ce,OrderedMap:$e,List:ze,Stack:Vt,Set:Dt,OrderedSet:qt,Record:Ct,Range:Z,Repeat:X,is:J,fromJS:G};return dn})},/***/
...
function(e,t,o){"use strict";var n=function(){function e(e,t){var o=[],n=!0,r=!1,s=void 0;try{for(var i,u=e[Symbol.iterator]();!(n=(i=u.next()).done)&&(o.push(i.value),!t||o.length!==t);n=!0);}catch(e){r=!0,s=e}finally{try{!n&&u.return&&u.return()}finally{if(r)throw s}}return o}return function(t,o){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,o);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),r=o("../node_modules/react/react.js"),s=r.PropTypes,i=r.createElement.bind(r,"div"),u=r.createElement.bind(r,"iframe"),a={position:"relative",height:0,overflow:"hidden",maxWidth:"100%"},l={position:"absolute",top:0,left:0,width:"100%",height:"100%"},d=function(e){var t=e.split(":").map(function(e){return Number(e)}),o=n(t,2),r=o[0],s=o[1];return s/r*100+"%"},c=function(e){var t=d(e.ratio),o=Object.assign({},a,{paddingBottom:t}),n=Object.assign({frameBorder:0},e,{style:l});return i({style:o},u(n))};c.defaultProps={src:"https://www.youtube.com/embed/dQw4w9WgXcQ",ratio:"16:9"},c.propTypes={src:s.string,ratio:function(e,t,o){if(!/\d+:\d+/.test(e[t]))return new Error('Invalid ratio supplied to ResponsiveEmbed. Expected a string like "16:9" or any 2 numbers seperated by a colon')}},e.exports=c},/***/
...
O=t.regeneratorRuntime=x?e.exports:{},O.wrap=n;var E="suspendedStart",k="suspendedYield",S="executing",P="completed",T={},I={};I[g]=function(){return this};var M=Object.getPrototypeOf,C=M&&M(M(_([])));C&&C!==y&&v.call(C,g)&&(
